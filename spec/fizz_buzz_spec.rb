...
RSpec.describe 'fizz_buzz' do
  {
    ...
    100 => [1, 2, 'Fizz', 4, 'Buzz', 'Fizz', 7, 8, 'Fizz', 'Buzz', 11, 'Fizz', 13, 14, 'FizzBuzz', 16, 17, 'Fizz', 19,
    ...
    it "fizz buzzes #{input} as #{expected_output}" do
      expect(fizz_buzz(input)).to eq(expected_output)
    end
  end
end
